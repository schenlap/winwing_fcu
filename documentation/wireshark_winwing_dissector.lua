...
local a0 = ProtoField.uint8 ("fcu.a0", "lcd altitude segment 1,0 + V/S MINUS", base.HEX)
local v4 = ProtoField.uint8 ("fcu.v4", "lcd v/s segment 4,3 + seg4 dot", base.HEX)
local v3 = ProtoField.uint8 ("fcu.v3", "lcd v/s segment ?", base.HEX)
local v2 = ProtoField.uint8 ("fcu.v2", "lcd v/s segment ?", base.HEX)
local v1 = ProtoField.uint8 ("fcu.v1", "lcd v/s segment ? + V/S FPA FLAG", base.HEX)
local v0 = ProtoField.uint8 ("fcu.v0", "lcd v/s segment ?", base.HEX)
...
usb_winwing_protocol.fields = { header, pkg_number, unknown1, unknown2, cmd1, alwaysone, unknown3, chksum, unknown4, unknown5, cmd2, alwayszero, s2, s1, s0, h3, h2, h1, h0, a5, a4, a3, a2, a1, a0, v4, v3, v2, v1, v0, res0, res1, res2 }
...
function usb_winwing_protocol.dissector(buffer, pinfo, tree)
  ...
  subtree:add_le(v4, buffer(38,1))
  subtree:add_le(v3, buffer(39,1))
  subtree:add_le(v2, buffer(40,1))
  subtree:add_le(v1, buffer(41,1))
  subtree:add_le(v0, buffer(42,1))
  subtree:add_le(res0, buffer(43,1))
  subtree:add_le(res1, buffer(44,1))
  subtree:add_le(res2, buffer(45,1))
end
