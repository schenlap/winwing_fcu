...
local v4 = ProtoField.uint8 ("fcu.v3", "lcd v/s segment 3,2 + seg4 dot", base.HEX)
local v3 = ProtoField.uint8 ("fcu.v2", "lcd v/s segment 2,1", base.HEX)
local v2 = ProtoField.uint8 ("fcu.v1", "lcd v/s segment 1,0", base.HEX)
local v1 = ProtoField.uint8 ("fcu.v0", "lcd v/s segment 0 + V/S FPA FLAG", base.HEX)
